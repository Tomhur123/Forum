...
import {apiUserResetConfirm, apiUserResetPassword, apiUserValidateEmail} from "@/net/api/user";
...
const validateEmail = () => apiUserValidateEmail(form.email, coldTime, 'reset')
